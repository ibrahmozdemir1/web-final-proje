  ...
  <body class="animsition">
    <div class="page-wrapper">
      ...
      <div class="page-container2">
        ...
        <div class="page-wrapper"><a href="adminProduct.jsp"><button class="btn btn-outline-danger" type="submit" 
            >Geri</button></a></div>
        <!-- Product begin -->
        <div class="page-wrapper">
            <div class="page-content--bge5" style="margin-top: -7%;">
              <div class="container">
