                    ...
                    <div class="table-responsive m-b-40">
                        <table class="table table-borderless table-data3">
                            ...
                            <tbody>
		                     ...
		                     %>
		                      <tr>
		                           <th scope="row"><%=urun.geturunAdi()  %></th>
...
<section>
  <a href="adminAddProduct.jsp" style="margin-left: 45%;">
    <button type="button"  class="btn btn-outline-success btn-lg active">Ürün Ekle</button></a>
</section>
        <!-- Product end -->
